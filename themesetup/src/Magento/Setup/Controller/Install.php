...
class Install extends AbstractActionController
{
    ...
    private function importDeploymentConfigForm()
    {
        ...
        $source['db'] = [];
        $source['db']['host'] = $data['db']['connection']['default']['host'];
        $source['db']['name'] = $data['db']['connection']['default']['dbname'];
        $source['db']['user'] = $data['db']['connection']['default']['username'];
        $source['db']['password'] = $data['db']['connection']['default']['password'];
        $source['db']['tablePrefix'] = $data['db']['table_prefix'];
